...
在使用任何懶人包之前，請確認以下準備工作已完成：

- [ ] Claude 帳號已註冊（Pro 方案以上）
- [ ] Claude Code 桌面版已安裝
- [ ] Git for Windows 已安裝（Windows 使用者）
- [ ] 已看過 EP01（了解 Chat / CoWork / Code 三個分頁）
- [ ] 已看過 EP02（了解什麼是 Skill）
...
- **Claude基本功 EP01**：一次搞懂 Claude 全生態
- **Claude基本功 EP02**：一次搞懂 Skills
